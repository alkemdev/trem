//! # trem-rung — Rung clip interchange format
//!
//! JSON-serializable **[`Clip`]** for **time × class** note data: rational beats, integer class
//! rows, voice lanes, and float metadata pairs. Optional **[`midi`]** import maps Standard MIDI
//! Files into this representation (see [`midi::MidiImportOptions`]).
//!
//! Specification narrative: `prop/piano-roll-editor-model.md` in the trem repo.
